<?php
/**
 * Template Name: Two Column Sidebar and Video
 */

get_header(); ?>

<main id="content" class="content a-team" itemscope itemtype="WebPageElement" itemprop="mainContentOfPage" tabindex="-1">
	<div class="container">
